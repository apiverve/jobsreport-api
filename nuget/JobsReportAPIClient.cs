...
namespace APIVerve.API.JobsReport
{
    ...
    /// <summary>
    /// Client for the JobsReport API
    /// </summary>
    public class JobsReportAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/jobsreport";
        ...
        public JobsReportAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JobsReportAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public JobsReportAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, JobsReportQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(JobsReportQueryOptions options)
        {
        ...
        public ResponseObj Execute(JobsReportQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(JobsReportQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(JobsReportQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(JobsReportQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(JobsReportQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(JobsReportQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(JobsReportQueryOptions options)
        {
