...
```gradle
dependencies {
    implementation 'com.github.apiverve:jobsreport-api:1.1.14'
}
```
...
```java
import com.apiverve.jobsreport.JobsReportAPIClient;
import com.apiverve.jobsreport.APIResponse;
import com.apiverve.jobsreport.APIException;

// Initialize the client
JobsReportAPIClient client = new JobsReportAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/jobsreport](https://docs.apiverve.com/ref/jobsreport)
...
- **Documentation:** [https://docs.apiverve.com/ref/jobsreport](https://docs.apiverve.com/ref/jobsreport)
- **Issues:** [GitHub Issues](https://github.com/apiverve/jobsreport-api/issues)
