// Package jobsreport provides a Go client for the Jobs Report API.
//
// For more information, visit: https://apiverve.com/marketplace/jobsreport?utm_source=go&utm_medium=readme
package jobsreport
...
// Request contains the parameters for the Jobs Report API.
//
// Parameters:
...
// ResponseData contains the data returned by the Jobs Report API.
type ResponseData struct {
	YearMonth string `json:"yearMonth"`
	Year int `json:"year"`
	Month int `json:"month"`
	Summary SummaryData `json:"summary"`
	NonfarmPayrolls NonfarmPayrollsData `json:"nonfarmPayrolls"`
	BySector BySectorData `json:"bySector"`
}

// SummaryData represents the summary object.
type SummaryData struct {
	UnemploymentRate float64 `json:"unemploymentRate"`
	LaborForceParticipation float64 `json:"laborForceParticipation"`
	TotalEmployed int `json:"totalEmployed"`
	TotalUnemployed int `json:"totalUnemployed"`
	LaborForce int `json:"laborForce"`
	JobsChange int `json:"jobsChange"`
}

// NonfarmPayrollsData represents the nonfarmPayrolls object.
type NonfarmPayrollsData struct {
	Total int `json:"total"`
	Private int `json:"private"`
}

// BySectorData represents the bySector object.
type BySectorData struct {
	Mining int `json:"mining"`
	Construction int `json:"construction"`
	Manufacturing int `json:"manufacturing"`
	TradeTransportUtilities int `json:"tradeTransportUtilities"`
	Information int `json:"information"`
	FinancialActivities int `json:"financialActivities"`
	ProfessionalBusiness int `json:"professionalBusiness"`
	EducationHealth int `json:"educationHealth"`
	LeisureHospitality int `json:"leisureHospitality"`
	OtherServices int `json:"otherServices"`
