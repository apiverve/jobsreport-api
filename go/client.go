...
const (
	baseURL        = "https://api.apiverve.com/v1/jobsreport"
	defaultTimeout = 30 * time.Second
)

// Client is the Jobs Report API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Jobs Report API client.
...
// Execute makes a request to the Jobs Report API with typed parameters.
//
