...
/**
 * Client for the Jobs Report API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/jobsreport?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/jobsreport';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\JobsreportClient] {$message}\n";
        }
    }
}
